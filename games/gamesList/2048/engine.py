...
class Game2048(BaseEngine):
    ...
    name = "2048"
    avatar = "media/avatars_games/2048.png"
    ...
    <div class="text-center">
        <img src="/media/pictures/2048_img02.png" alt="2048 стратегия" class="img-fluid mb-3">
    </div>
    ...
    <div class="text-center">
        <img src="/media/pictures/2048_img01.png" alt="2048 стратегия" class="img-fluid mb-3">
    </div>
    ...
    <div class="text-center">
        <img src="/media/pictures/2048_img04.png" alt="2048 стратегия" class="img-fluid mb-3">
    </div>
    ...
    <div class="text-center">
        <img src="/media/pictures/2048_img05.png" alt="2048 стратегия" class="img-fluid mb-3">
    </div>
    ...
    <div class="text-center">
        <img src="/media/pictures/2048_img03.png" alt="2048 стратегия" class="img-fluid mb-3">
    </div>
    ...
    <div class="ratio ratio-16x9 mb-3">
        <video class="w-100" controls preload="metadata">
            <source src="/media/files/2048_record_2.mp4" type="video/mp4">
